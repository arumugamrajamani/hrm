...
-- =====================================================================
-- SECTION 10: PERFORMANCE MANAGEMENT SYSTEM
-- =====================================================================
...
CREATE TABLE performance_self_ratings (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE performance_manager_ratings (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    goal_id BIGINT NOT NULL,
    employee_id BIGINT NOT NULL,
    manager_id BIGINT NOT NULL,
...
CREATE TABLE performance_overall_ratings (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    cycle_id BIGINT NOT NULL,
    employee_id BIGINT NOT NULL,
    manager_id BIGINT NOT NULL,
...
CREATE TABLE performance_annual_summaries (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    fiscal_year YEAR NOT NULL,
    employee_id BIGINT NOT NULL,
